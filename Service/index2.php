<?php
 ...
 $resultname="";
  ...
  $pdo_statement = $pdo_conn->prepare("SELECT distinct idService FROM listservice where idService ='$idS' ");
	$pdo_statement->execute();
...
<caption>
  ...
  <div class="container-fluid">
    ...
    <?php //l'affichage du tableau d'absence
        ...
        $pdo_statement = $pdo_conn->prepare("SELECT distinct * FROM service s,listservice l where s.idService=l.idService and s.idService='$Nomservice' and l.date BETWEEN '".$premier_jour_semaine."' AND '".$dernier_jour_semaine."' order by l.matricule ASC");
				$pdo_statement->execute();
