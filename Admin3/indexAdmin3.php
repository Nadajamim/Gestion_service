...
// Afficher la semaine en cours par jour et mois
  ...
  $pdo_statement = $pdo_conn->prepare("SELECT idemployer,nom,prenom FROM employer WHERE idService = 3 order by idemployer ASC");
	$pdo_statement->execute();
...
<div class="w3-sidebar w3-ios-orange w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <a href="indexAdmin3.php" class="w3-bar-item w3-button"><i class="fa fa-home fa-2x"></i><span style="color:white;padding-left:30px;font-size:30px;">Accueil</span></a>
